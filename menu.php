...
<nav class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="?page=utama">Sistem Informasi Arsip Kejaksaan Negeri Asahan</a>
        </div>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="?page=pemberkasan&actions=tampil">Pemberkasan</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="?page=arsip&actions=report">Laporan Arsip</a></li>
						            <li><a href="?page=pemberkasan&actions=report">pemberkasan</a></li>
                    </ul>
                </li>
