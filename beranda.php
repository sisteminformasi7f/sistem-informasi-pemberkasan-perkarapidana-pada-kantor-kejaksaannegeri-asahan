    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-warning">
                <strong>Selamat Datang di SIA Kejaksaan Negeri Asahan</strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-3 col-xs-12">
            ...
            <div class="alert alert-dsucces">Maaf! Login Gagal, Coba Lagi..</div>
            <?php }?>
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <button type="submit" name="login" value="login"
                                        class="btn btn-warning btn-block"><span class="fa fa-unlock-alt"></span>
                                    Login Sistem
                                </button>
                            </div>
                    </form>
